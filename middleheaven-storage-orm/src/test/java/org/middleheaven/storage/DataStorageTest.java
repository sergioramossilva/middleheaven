...
//	static DomainStoreService service;
//	
...
//		DataBaseStorage dataStorage = new DataBaseStorage(provider.getDataSource(), new DomainWrapPersistableModelReader(model));
//
...
//
//		
//		public DSInjectionTester (@Name("ds") DomainStore store){
//			this.store = store;
//		}
//		
//		public boolean test() {
