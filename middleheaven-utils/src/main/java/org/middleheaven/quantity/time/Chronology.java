 ...
 * All int value correspond to ordinal values (i.e. 1- first, 2- secound, 3-thirs , and so on ...)
 */
public abstract class Chronology {
	...
	/**
	 * Transforms a year, month, day information into milisecounds from 1990, January 1st 
	 * 
	...
	/**
	 * Transforms a time fields ( year, month, day , hour, minutes, secounds, miliseconds) information into milisecounds from 1990, January 1st 
	 * @param lenient
	 * @param fields
	 * @return
	 */
