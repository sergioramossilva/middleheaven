...
import org.middleheaven.storage2.EntityStoreListener;
import org.middleheaven.storage2.EntityStoreService;
...
public class EntityStoreRepository<E> extends AbstractRepository<E>  {
	...
	private EntityStoreListener storageListener;
	...
	public void addRepositoryListener(RepositoryListener listener) {
		...
		if (storageListener==null){
			storageListener = new EntityStoreListener(){
