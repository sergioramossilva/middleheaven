 ...
 * for details.
 */
class NIOFSDirectory extends ManagedFileDirectory {
  ...
  public IndexInput openInput(String name, int bufferSize) throws IOException {
    ensureOpen();
    return new NIOFSIndexInput(getFile().retrive(name), bufferSize, getReadChunkSize());
  }
  ...
  public IndexOutput createOutput(String name) throws IOException {
    initOutput(name);
    return new SimpleFSDirectory.SimpleFSIndexOutput(directory.retrive(name));
  }
