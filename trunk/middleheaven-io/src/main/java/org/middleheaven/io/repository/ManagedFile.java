...
public interface ManagedFile extends Watchable , StreamableContentSource {
	...
	/**
	 * Indicates if the modification date is traceable for this file type and implementation.
	 * @return <code>true</code> if the modification date is traceable
	 */
	public boolean isModificationTraceable();
	
	/**
	 * Returns an instance of {@link ManagedModificationTrace} if {@link #isModificationTraceable()} is <code>true</code>. Throws an {@link ModificationNotTracableIOException} exception otherwise
	 * @return an instance of {@link ManagedModificationTrace}. 
