...
public class EnhancedMapAdapter<K,V> extends AbstractAdapter<Map.Entry<K, V>> implements EnhancedMap<K, V> {
	...
	@Override
	public EnhancedCollection<Map.Entry<K, V>> reject(Classifier<Boolean, Map.Entry<K, V>> classifier){
		return findAll(new NegationClassifier<Map.Entry<K, V>>(classifier));
	}
