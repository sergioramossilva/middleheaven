 ...
 */
public class ComposedClassifier<T> implements BooleanClassifier<T>{
    ...
    public ComposedClassifier(ComposedClassifier<T> other){
        this.filters.addAll(other.filters);
        this.logicOperator = other.logicOperator;
    }

    public ComposedClassifier(LogicOperator operator){
        setOperator(operator);
    }

    public ComposedClassifier( BooleanClassifier<T> a ,LogicOperator operator, BooleanClassifier<T> b){
        setOperator(operator);
        filters.add(a);
        filters.add(b);
    }
    ...
    public ComposedClassifier<T> addFilter(BooleanClassifier<T> filter){
        filters.add(filter);
        return this;
    }
